...
const s = {
  ...
  iucnBadge: (s) => ({ padding: '2px 8px', borderRadius: 10, fontSize: 11, fontWeight: 700, background: s === 'EN' || s === 'CR' ? '#f8d7da' : s === 'VU' ? '#fff3cd' : '#d1e7dd', color: '#333' }),
...
export default function PlantList() {
  ...
  return (
    <div style={s.page}>
      ...
      <div style={s.filters}>
        <input style={s.input} placeholder="Search species, family…" value={search}
        ...
        <table ref={tableRef} style={s.table}>
          <thead>
            <tr>
              ...
              <th style={s.th}>IUCN</th>
              <th style={s.th}>Flowering</th>
